...
import {DoSResistantAuction as Auction} from "./Auction.sol";

/// @title AuctionFactory
/// @notice Deploy a new Auction.
/// @dev Uses `Clonable` to deploy minimal proxy clones of `DoSResistantAuction`, aliased here as `Auction`.
///      Only difference from the base `AuctionFactory` is the use of a gated `kick()` function in the cloned auctions.
contract AuctionFactory is Clonable {
    ...
    function createNewAuction(
        ...
        return _createNewAuction(_want, msg.sender, msg.sender, DEFAULT_AUCTION_LENGTH, DEFAULT_STARTING_PRICE);
    }
    ...
    function createNewAuction(
        ...
        return _createNewAuction(_want, _receiver, _governance, _auctionLength, DEFAULT_STARTING_PRICE);
    }
    ...
    function createNewAuction(
        ...
        return _createNewAuction(_want, _receiver, _governance, _auctionLength, _startingPrice);
    }
    ...
    function _createNewAuction(
        ...
        Auction(_newAuction).initialize(_want, _receiver, _governance, _auctionLength, _startingPrice);
