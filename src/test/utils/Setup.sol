...
import {rsETHOracle} from "../../periphery/Oracles/rsETHOracle.sol";
import {weETHOracle} from "../../periphery/Oracles/weETHOracle.sol";
...
contract Setup is ExtendedTest, IEvents {
    ...
    // uint256 public collateralChainlinkPriceOracleHeartbeat = 86400 * 2; // Chainlink docs say 86400 seconds, we double it
    // address public auctionFactory = address(0xbC587a495420aBB71Bbd40A0e291B64e80117526); // Newest Auction Factory
    ...
    // uint256 public collateralChainlinkPriceOracleHeartbeat = 86400; // Chainlink docs say 3600 seconds, we use 24 hours
    // address public auctionFactory = address(0xbC587a495420aBB71Bbd40A0e291B64e80117526); // Newest Auction Factory
    ...
    function setUpStrategy() public returns (address) {
        ...
        if (collateralChainlinkPriceOracle == address(0)) {
            // collateralChainlinkPriceOracle = address(new wstETHOracle());
            // collateralChainlinkPriceOracle = address(new rETHOracle());
            // collateralChainlinkPriceOracle = address(new rsETHOracle());
            collateralChainlinkPriceOracle = address(new weETHOracle());
        }
