...
contract DeployStrategies is Script {
    ...
    function run() external {
        ...
        address _wethStrategy =
            STRATEGY_FACTORY.newStrategy(_wethAddressesRegistry, ASSET, address(0), "Liquity V2 WETH Stability Pool");
        ...
        address _wstethStrategy = STRATEGY_FACTORY.newStrategy(
            _wstethAddressesRegistry, ASSET, address(0), "Liquity V2 wstETH Stability Pool"
        );
        ...
        address _rethStrategy =
            STRATEGY_FACTORY.newStrategy(_rethAddressesRegistry, ASSET, address(0), "Liquity V2 rETH Stability Pool");
